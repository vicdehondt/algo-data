...
(library
 (fibonacci)
 (export initialize size-free overhead null locate-free pop-free push-free peek poke! prn)
 (import (rnrs base)
         (rnrs io simple)
         (rnrs control))
