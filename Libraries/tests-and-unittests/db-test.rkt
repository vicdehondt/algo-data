...
(display "FILL UP PLANETEN TABLE")(newline)
...
(display "FILL UP MANEN TABLE")(newline)
...
(define manual-delete? #t)
(cond (manual-delete? (newline)(newline)(newline)
       (display "MANUAL DELETE TEST")(newline)
       (db:delete-where! zonnestelsel planeten :planeet-naam: "Mercurius") ; fst index
       (db:delete-where! zonnestelsel planeten :planeet-naam: "Venus")
       (db:delete-where! zonnestelsel planeten :planeet-naam: "Aarde")
       (db:delete-where! zonnestelsel planeten :omlooptijd: 1.881)        ; snd index
       (db:delete-where! zonnestelsel planeten :omlooptijd: 11.862)
       (db:delete-where! zonnestelsel planeten :omlooptijd: 29.458)
       (db:delete-where! zonnestelsel planeten :afstand-tot-zon: 19.1819) ; gewoon sequentieel
       (db:delete-where! zonnestelsel planeten :afstand-tot-zon: 30.0578)
       (db:delete-where! zonnestelsel planeten :afstand-tot-zon: 39.2975)
       (db:delete-where! zonnestelsel manen :planeet: "Aarde")
       (db:delete-where! zonnestelsel manen :planeet: "Mars")
       (db:delete-where! zonnestelsel manen :planeet: "Jupiter")
       (db:delete-where! zonnestelsel manen :planeet: "Saturnus")
       (db:delete-where! zonnestelsel manen :planeet: "Uranus")
       (db:delete-where! zonnestelsel manen :planeet: "Neptunus")
